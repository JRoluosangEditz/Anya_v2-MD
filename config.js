...
module.exports = {
     ...
     */
    botname: process.env.BotName || "۝vAiPA۝",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐐𝐮𝐞𝐞𝐧 𝐀𝐧𝐲𝐚 𝐁𝐨𝐭",
    prefa: process.env.PREFIX || process.env.Prefix || "✓",
    themeemoji: process.env.ThemeEmoji || "🎐",

    /**
     * This bot is made by J Rohluosang Editz 
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "۝vAiPA۝",
    ownernumber: process.env.Owner_Number || "917005658594",
    instagramId: process.env.Insta || "ka_ning_ka_kal_dawn",

    /**
     * other details and parameters
     */
    author: process.env.Author || "𝐏𝐢𝐤𝐚𝐁𝐨𝐭𝐳 🌚🌙",
    packname: process.env.PackName || "۝vAiPA۝",
    socialLink: process.env.Web || "https://github.com/JRohluosangEditz",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/E490r0wSpSr89XkCWeGt",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "YOUR_MONGODB_URL",
    sessionId: process.env.SESSION_ID || "PTPkYZ0Z2Y_A_N_Y_A_V_2_mxkQDvOIL9",
